...
if($action == 'create')
{
	$sql= "INSERT INTO `tbl_user`(`firstname`, `lastname`, `username`, `email`, `address`, `address2`, `ccname`, `ccnumber`, `ccexpire`, `cvv`, `foto`, `time_insert`) VALUES ('$hasil[firstname]','$hasil[lastname]'
		,'$hasil[username]','$hasil[email]','$hasil[address]','$hasil[address2]','$hasil[ccname]','$hasil[ccnumber]','$hasil[ccexpire]','$hasil[cvv]','{$namafilebaru}',now())";
}
...
$conn = new mysqli("localhost","root","","billing_address");
